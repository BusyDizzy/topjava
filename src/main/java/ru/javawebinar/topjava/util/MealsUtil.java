...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак Админа", 999, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед Админа", 600, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин Админа", 70, 2)
    );
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, LocalTime startTime, LocalTime endTime) {
        return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenHalfOpenByTime(meal.getDateTime(), startTime, endTime));
    }
