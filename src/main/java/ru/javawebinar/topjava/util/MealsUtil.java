...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак", 999),
            new Meal(2, LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед", 600),
            new Meal(2, LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин", 70)
    );
