...
class AdminRestControllerTest extends AbstractControllerTest {
    ...
    void getWithMeals() throws Exception {
        ResultActions action = perform(MockMvcRequestBuilders.get(REST_URL + ADMIN_ID + "/with-meals"))
                ...
                // https://jira.spring.io/browse/SPR-14472
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
        User created = USER_MATCHER_WITH_MEALS.readFromJson(action);
        USER_MATCHER.assertMatch(created, UserTestData.admin);
        MEAL_MATCHER.assertMatch(created.getMeals(), MealTestData.adminMeal2, MealTestData.adminMeal1);
    }
}